...
<div dir="{{ $lang == 'ar' ? 'ltr' : 'rtl' }}" class="bg-[color:var(--navy)] text-white antialiased">
    ...
    <footer class="max-w-[1400px] mx-auto px-6 md:px-12 pb-8 pt-16">
            ...
            <div class="flex items-center gap-4 w-full">
                ...
                <div class="w-full">
                    ...
                    <div class="subscribe-pill rounded-3xl flex items-center overflow-hidden">
                        <input type="email" placeholder="{{ $lang == 'ar' ? 'ادخل بريدك الالكتروني للاشتراك في آخر الأخبار' : 'Enter your email to get the latest news' }}" class="w-full bg-transparent placeholder:opacity-60 px-6 py-3 text-right focus:outline-none text-sm" />
                    </div>
                </div> <button class="bg-white text-[color:var(--navy)] px-5 py-2 rounded-full shadow-sm"> {{ $lang == 'ar' ? 'اشترك' : 'Subscribe' }}</button>
        ...
        <div dir="{{ $lang == 'ar' ? 'ltr' : 'rtl' }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
            ...
            <div class="space-y-4">
                ...
                <a dir="{{ $lang == 'ar' ? 'rtl' : 'ltr' }}" href="{{ $footerSocial?->app_store_url ?: '#' }}" @if(! empty($footerSocial?->app_store_url)) target="_blank" rel="noopener noreferrer" @endif class="inline-flex items-center justify-center gap-3 border border-white/20 rounded-lg px-3 py-2 w-40">
                    <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12.0656 3.49062C12.8772 2.51641 13.277 1.26423 13.1802 0C11.9403 0.13022 10.7951 0.722779 9.97259 1.65961C9.1683 2.57494 8.74975 3.80509 8.82888 5.021C10.0692 5.03377 11.2885 4.45727 12.0656 3.49062Z" fill="white" />
                    </svg>
                ...
                <!-- Play Store badge -->
                <a dir="{{ $lang == 'ar' ? 'rtl' : 'ltr' }}" href="{{ $footerSocial?->google_play_url ?: '#' }}" @if(! empty($footerSocial?->google_play_url)) target="_blank" rel="noopener noreferrer" @endif class="inline-flex items-center justify-center gap-3 border border-white/20 rounded-lg px-3 py-2 w-40">
        ...
        <div dir="{{ $lang === 'ar' ? 'rtl' : 'ltr' }}" class="sm:flex grid items-center justify-between gap-6 border-t border-white/10 pt-4 text-[color:var(--muted)] text-sm">
            <div class="flex items-center gap-4">
                ...
                <a class="p-2 rounded-full hover:bg-white/5" href="#" aria-label="tiktok">
                ...
                <a class="p-2 rounded-full hover:bg-white/5" href="#" aria-label="instagram">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="p-2 rounded-full hover:bg-white/5" href="#" aria-label="linkedin">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="p-2 rounded-full hover:bg-white/5" href="#" aria-label="twitter">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
