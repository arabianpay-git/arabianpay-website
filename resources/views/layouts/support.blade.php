...
<head>
    ...
    <title>@lang('messages.metatitle') - {{ app()->getLocale() == 'ar' ? 'مركز المساعدة' : 'Support Center' }}</title>
...
<body class="">
    ...
    <div class="mx-3"> @livewire('support.support-hero')</div>

    @livewire('support.support-content')
    @livewire('support.support-contact')
