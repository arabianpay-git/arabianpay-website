@php
$isAr = $lang === 'ar';
$title = $isAr ? 'الأخبار والتحديثات' : 'News & Updates';
$description = $isAr ? 'تابع آخر الأخبار والتحديثات من ArabianPay' : 'Stay updated with the latest news and updates from ArabianPay';
@endphp
...
<div dir="{{ $isAr ? 'rtl' : 'ltr' }}" class="relative bg-gray-900 max-w-7xl mx-auto m-4 w-full p-4 overflow-hidden rounded-3xl md:p-12 lg:p-24" style="background: linear-gradient(135deg, #0B1140 0%, #1e3a8a 50%, #3b82f6 100%);">
    ...
    <div class="relative z-10  w-full h-full lg:flex-row-reverse lg:items-center">
        ...
        <div class="flex flex-col w-full">
            ...
            <p class="mt-4 text-lg text-gray-300 max-w-xl opacity-0 translate-y-6" data-animate data-delay="200">
                {{ $description }}
            </p>
        </div>
    </div>
