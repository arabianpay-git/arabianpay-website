...
<div dir="{{ $lang == 'ar' ? 'rtl' : 'rtl' }}"  class="bg-neutral-50">
                ...
                <div class="border-b border-neutral-300 opacity-0 translate-y-6" data-animate data-delay="{{ 150 + ($loop->index * 80) }}">
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-xl text-[#1a2b5b] font-medium text-right"  dir="{{ $lang == 'ar' ? 'rtl' : 'ltr' }}" >
                                {{ $question }}
                            </span>
                    ...
                    <!-- Animated content -->
                    <div
                        class="faq-content max-h-0 overflow-hidden opacity-0 transition-[max-height,opacity] duration-300 ease"
                        id="{{ $faqId }}"
                        aria-hidden="true"
                    >
                        <p class="py-4 px-2 text-neutral-600 text-right" dir="{{ $lang == 'ar' ? 'rtl' : 'ltr' }}">
                            {!! nl2br(e($answer)) !!}
                        </p>
                    </div>
                </div>
