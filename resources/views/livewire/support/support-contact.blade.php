        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 ">
            ...
            <div dir="{{ $isAr ? 'rtl' : 'ltr' }}" class="lg:col-span-6" >
                <div class="bg-neutral-50 rounded-3xl p-10">
                    ...
                    <form wire:submit.prevent="submit" class="space-y-6" dir="{{ $isAr ? 'rtl' : 'ltr' }}">
                        <div>
                        ...
                        <button type="submit" class="w-full bg-[#0B1140] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-opacity-90 transition-all transform hover:scale-105 shadow-lg" wire:loading.attr="disabled">
