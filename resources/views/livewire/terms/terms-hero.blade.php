@php
$isAr = $lang === 'ar';
$title = $condition?->{"title_{$lang}"} ?? ($isAr ? 'الأحكام والشروط' : 'Terms & Conditions');
@endphp
                ...
                @empty
                    <div class="flex flex-col opacity-0 translate-y-6" data-delay="150" data-animate>
                        <div class="flex space-x-1 space-x-reverse">
                            ...
                            <span class="text-lg font-semibold whitespace-nowrap">{{ $isAr ? 'شروط واضحة' : 'Clear Terms' }}</span>
                        </div>
                        <p class="mt-1 text-sm text-gray-300">
                            {{ $isAr ? 'نقدم شروطاً واضحة وشفافة لاستخدام منصتنا' : 'We provide clear and transparent terms for using our platform' }}
                        </p>
                    </div>
                @endforelse
            </div>
