...
use App\Http\Controllers\SupportCaptchaController;
use App\Http\Controllers\SupportContactFormController;
    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('/support/captcha', [SupportCaptchaController::class, 'image'])->name('support.captcha');

                Route::post('/support/contact', [SupportContactFormController::class, 'store'])->name('support.contact.store');
